...
var resizePizzas = function (size) {
    ...
    // Changed all case selectors to use getElementsById method
    ...
    // Changed windowWidth to use getElementByID method
    ...
    // I pulled these variables out of the loop from 
    // below because they were slowing everything down
    // Also changed to the getElementsByClassName method
    var pizzaContainer = document.getElementsByClassName("randomPizzaContainer");
    var pizzaContainerLength = pizzaContainer.length;
    var dx = determineDx(pizzaContainer[0], size);
    var calcWidth = (pizzaContainer[0].offsetWidth + dx) + 'px';

    // Iterates through pizza elements on the page and changes their widths
    function changePizzaSizes(size) {
        for (var i = 0; i < pizzaContainerLength; i++) {
            pizzaContainer[i].style.width = calcWidth;
        }
    }
...
// Changed to getElementByID method
// Moved teh var pizzasDiv outside of the loop for faster performance
...
// Removed the elem var from the loop, as well as className, src, height, and width to 
// try and speed up the function.
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // put items back in the for loop
